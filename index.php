                    ...
                    <div class="card-body">
                      <a href="javascript:void(0);" style="color: #d2d2e8;" onclick="showToastrNotification('error', 'Fake bill Momo chưa khả dụng...', 'Thông báo');">
                        ...
                        <div class="text-center">
                          <span>Momo</span>
                          <br><small style="color:#e80221;">Đéo có</small>
                        </div>
                      </a>
                    </div>
                  </div>
  ...
  <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl">
                <div class="footer-container d-flex align-items-center justify-content-between py-3 flex-md-row flex-column">
                  <div class="mb-2 mb-md-0">© codevipgiare.com-<script>document.write(new Date().getFullYear());</script>
...
<p><i><span style="font-family: helvetica;">Website Được Điều Hành Bởi: </span><strong><a href="https://codevipgiare.com/ " rel="noopener" target="_blank"><span style="font-family: helvetica;">codevipgiare.com</span></a>&nbsp;</strong></i><img alt="" data-original-height="348" data-original-width="348" height="20" src="https://blogger.googleusercontent.com/img/a/AVvXsEgTuK2vHvY-dvIdyyvVZ5-01rq5gpe8DKxJy1RLFNVElEqBXbep_l7xLwkQCKIOAYmonQNKLBwNpwEosc-k--y7IguNfzdSgX2m1GybLl9FCV9Othb67-JoaRsDjHrtifoPtTwG9XaoZLAhR74tRK5FhXTRoMy5RyV6CUlKqrzaimWIUh5bBPaSdtYylBc2=w20-h20" width="20" /></p><p><span style="font-family: helvetica;">Subscribe for me: <a href="https://hethongdev.store" target="_blank">codevipgiare.com</a></span></p><p><span style="font-family: helvetica;">*</span><span style="font-family: arial;"><b style="color: red;">Lưu Ý: </b><i>website được làm ra với mục đích học tập. Mọi hành vi vi phạm pháp luật chúng tôi không chịu trách nhiệm.</i></span></p><div class="separator" style="clear: both; text-align: center;"><span style="font-family: arial;"><i></i></span></div>
